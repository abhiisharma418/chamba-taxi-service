    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-700">{currentBooking.pickup.address}</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-red-500 rounded-full"></div>
                    <span className="text-sm text-gray-700">{currentBooking.destination.address}</span>
                  </div>
                </div>
              </div>
              <div className="text-right">
                ...
                <div className={`font-semibold capitalize ${
                  currentBooking.status === 'requested' ? 'text-yellow-600' :
                  currentBooking.status === 'accepted' ? 'text-blue-600' :
                  currentBooking.status === 'on-trip' ? 'text-green-600' : 'text-gray-600'
                }`}>
            ...
            <div className="mt-4 pt-4 border-t border-blue-200">
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-blue-900">₹{currentBooking.fare.estimated}</span>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          >
            <div className="flex items-center">
              <div className="bg-emerald-100 p-3 rounded-full group-hover:bg-emerald-200 transition-colors duration-200">
                <Clock className="h-6 w-6 text-emerald-600" />
              </div>
              <div className="ml-4">
                <h3 className="text-lg font-semibold text-gray-900">Ride History</h3>
                <p className="text-gray-600">View past rides</p>
              </div>
            </div>
          </Link>
