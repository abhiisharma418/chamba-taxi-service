    ...
    <div className={`flex items-center space-x-3 ${className} rwu-logo-container`}>
      ...
      <div className={`${sizeClasses[size]} relative group cursor-pointer rwu-3d-effect`}>
        <div className="w-full h-full bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 rounded-2xl flex items-center justify-center shadow-2xl border-2 border-blue-400/30 group-hover:scale-110 group-hover:rotate-[360deg] transition-all duration-700 ease-in-out overflow-hidden transform-gpu rwu-pulse-border-effect">
          ...
          {/* Combined RWU Text Design with Enhanced Effects */}
          <div className={`relative z-10 flex items-center space-x-0.5 ${rwuTextSize[size]} rwu-premium-text`}>
            <span className="rwu-letter text-white font-black tracking-tight drop-shadow-lg transform group-hover:scale-110 transition-transform duration-300 rwu-glow-effect" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
              R
            </span>
            <span className="rwu-letter text-blue-200 font-black tracking-tight drop-shadow-lg transform group-hover:scale-110 transition-transform duration-300 delay-75" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
              W
            </span>
